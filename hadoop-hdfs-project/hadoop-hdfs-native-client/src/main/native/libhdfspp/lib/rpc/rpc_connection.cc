...
void RpcConnection::AsyncRpc(
  ...
  //TODO:Log LogMessage(kDebug, kRPC) << "RpcConnection::AsyncRpc called (connected=" << ToString(connected_) << ")";
...
void RpcConnection::PreEnqueueRequests(
  ...
  //TODO:Log LogMessage(kDebug, kRPC) << "RpcConnection::PreEnqueueRequests called";
